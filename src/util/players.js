import gabigol from "../assets/players/gabigol.jpg";
import arrascaeta from "../assets/players/arrascaeta.jpg";
import ayrtonlucas from "../assets/players/ayrtonlucas.jpg";
import brunohenrique from "../assets/players/brunohenrique.jpg";
import cebolinha from "../assets/players/cebolinha.jpg";
import cleiton from "../assets/players/cleiton.jpg";
import davidluiz from "../assets/players/davidluiz.jpg";
import diegoribas from "../assets/players/diegoribas.jpg";
import evertonribeiro from "../assets/players/evertonribeiro.jpg";
import fabriciobruno from "../assets/players/fabriciobruno.jpg";
import filipeluis from "../assets/players/filipeluis.jpg";
import joaogomes from "../assets/players/joaogomes.jpg";
import lazaro from "../assets/players/lazaro.jpg";
import leopereira from "../assets/players/leopereira.jpg";
import marinho from "../assets/players/marinho.jpg";
import matheuscunha from "../assets/players/matheuscunha.jpg";
import matheusfranca from "../assets/players/matheusfranca.jpg";
import matheuzinho from "../assets/players/matheuzinho.jpg";
import neneca from "../assets/players/neneca.jpg";
import pablo from "../assets/players/pablo.jpg";
import pedro from "../assets/players/pedro.jpg";
import rodinei from "../assets/players/rodinei.jpg";
import rodrigocaio from "../assets/players/rodrigocaio.jpg";
import santos from "../assets/players/santos.jpg";
import thiagomaia from "../assets/players/thiagomaia.jpg";
